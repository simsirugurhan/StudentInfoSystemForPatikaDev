...
public class Student {
	...
	public void printNote(){
        ...
        System.out.println("Matematik , Sınav notu : " + this.mat.note   +" , Sözlü notu : "+ this.mat.verbalNote   +"   Oran: sınav; %80  sözlü; %20");
        System.out.println("Fizik     , sınav notu : " + this.fizik.note +" , Sözlü notu : "+ this.fizik.verbalNote +"   Oran: sınav; %80  sözlü; %20");
        System.out.println("Kimya     , sınav notu : " + this.kimya.note +" , Sözlü notu : "+ this.kimya.verbalNote +"   Oran: sınav; %80  sözlü; %20");
    }
	//<-- MY CODES
}
